...
const SLUG: Record<number, string> = {
  ...
  111:"oracle",113:"arc_warden",114:"monkey_king",119:"dark_willow",120:"pangolier",121:"grimstroke",123:"hoodwink",126:"void_spirit",128:"snapfire",129:"mars",
  135:"dawnbreaker",136:"marci",137:"primal_beast",138:"muerta",145:"kez",
};
const NAMES: Record<number, string> = {
  1:"Anti-Mage",8:"Juggernaut",10:"Morphling",74:"Invoker",106:"Ember Spirit",41:"Faceless Void",14:"Pudge",17:"Storm Spirit",44:"Phantom Assassin",93:"Slark",
};
const title = (s: string) =>
  s.split(" ").map((w) => (w ? w[0].toUpperCase() + w.slice(1) : w)).join(" ");

export const heroPortrait = (id: number) => (SLUG[id] ? `${CDN}/${SLUG[id]}.png` : "");
export const heroName = (id: number) =>
  NAMES[id] || (SLUG[id] ? title(SLUG[id].replace(/_/g, " ")) : `Hero ${id}`);
